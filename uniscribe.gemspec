...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "unicode-name", "~> 1.11"
  gem.add_dependency "unicode-sequence_name", "~> 1.11"
  gem.add_dependency "unicode-display_width", "~> 2.3"
  gem.add_dependency "unicode-emoji", "~> 3.3"
  gem.add_dependency "unicode-version", "~> 1.2"
  gem.add_dependency "symbolify", "~> 1.4"
  gem.add_dependency "characteristics", "~> 1.5"
